...
public class LdaUtil
{
     ...
     * @param i2cHashMap
     */
    public static void explain(Map<String, Double>[] result, HashMap<Integer, String> i2cHashMap)
    {
        int i = 0;
        for (Map<String, Double> topicMap : result)
        {
            System.out.printf("topic %d :\n", i++);
            explain(topicMap,i2cHashMap);
            System.out.println();
        }
    }

    public static void explain(Map<String, Double> topicMap, HashMap<Integer, String> i2cHashMap)
    {
