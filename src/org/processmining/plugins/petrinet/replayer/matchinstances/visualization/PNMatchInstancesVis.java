 ...
 * 
 */
@Plugin(name = "Project All Alignments to Log", returnLabels = { "Visualized All Log-Model Alignments Projected to Log" }, returnTypes = { JComponent.class }, parameterLabels = { "All Log-Model alignment" }, userAccessible = false)
@Visualizer
